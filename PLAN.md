...
- Complete typed cross-shard channel ownership. JOIN, PART, QUIT, KICK, TOPIC,
  KNOCK, single-line messages, TAGMSG, and batches/multiline route to the
  channel owner. Nick reservations are process-wide and atomically claimed.
  INVITE, MODE, channel queries, services, history, persistence callbacks, and
  HTTP controls still need the same boundary.
