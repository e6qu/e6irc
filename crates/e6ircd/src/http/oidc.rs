...
/// Returns `false` (rate-limited) when the bucket is empty; always `true` when
/// `auth_rate_burst` is unset. The
...
pub(super) fn auth_rate_ok(state: &AppState, client: crate::net::ClientIp) -> bool {
